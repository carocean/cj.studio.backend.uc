...
public interface IRoleStub {
	...
	@CjStubReturn(type = ArrayList.class,elementType=Role.class, usage = "返回角色，Json格式")
	...
	@CjStubReturn(type = ArrayList.class,elementType=User.class, usage = "返回机构成员，Json格式")
	...
	@CjStubReturn(type = ArrayList.class,elementType=Role.class, usage = "角色集合")
